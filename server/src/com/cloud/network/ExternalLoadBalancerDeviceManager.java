...
public interface ExternalLoadBalancerDeviceManager extends Manager {
     ...
     *            physical network id of the network in to which device to be
     *            added
     * @param url
     ...
     *            device name
     * @param server
     *            resource that will handle the commands specific to this device
    ...
    public ExternalLoadBalancerDeviceVO addExternalLoadBalancer(long physicalNetworkId, String url, String username, String password, String deviceName, ServerResource resource,
            boolean gslbProvider, boolean exclusiveGslbProvider, String gslbSitePublicIp, String gslbSitePrivateIp);
    ...
    /**
     * list external load balancers of given device name type added in to a
     * physical network
     *
     * @param physicalNetworkId
     * @param deviceName
     * @return list of host objects for the external load balancers added in to
     ...
     *            guest network
     * @param dedicatedLb
     *            true if a dedicated load balancer is needed for this guest
     *            network
     ...
     * @param network
     *            guest network id
     * @return ExternalLoadBalancerDeviceVO object corresponding the load
     *         balancer device assigned for this guest network
     */

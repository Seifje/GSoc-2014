...
public interface HighAvailabilityDao extends GenericDao<HaWorkVO, Long> {
    ...
    /**
     * Finds all the work items that were successful and is now ready to be
     * purged.
     *
     * @param time
     *            that the work item must be successful before.
     * @return list of WorkVO or empty list.
     */
    ...
    /**
     * finds out if a work item has been scheduled for this work type but has
     * not been taken yet.
     *
     * @param instanceId
     *            vm instance id
     * @param type
     *            type of work scheduled for it.
    ...
    /**
     * Look for HA work that has been scheduled for a vm since a certain work
     * id.
     *
     * @param vmId
     *            virtual machine id.

...
public class NetworkDaoTest extends TestCase {
    public void testTags() {
        ...
        //
        // dao.expunge(1001l);
        // NetworkVO network = new NetworkVO(1001, TrafficType.Control,
        // GuestType.Shared, Mode.Dhcp, BroadcastDomainType.Native, 1, 1, 1, 1,
        // 1001, "Name", "DisplayText", false, true, true, null, null);
        ...
        // Assert.assertTrue(saveTags.size() == 2 && saveTags.contains("a") &&
        // saveTags.contains("b"));
        //
        // NetworkVO retrieved = dao.findById(1001l);
        // List<String> retrievedTags = retrieved.getTags();
        // Assert.assertTrue(retrievedTags.size() == 2 &&
        // retrievedTags.contains("a") && retrievedTags.contains("b"));
        //
        ...
        // Assert.assertTrue("Unable to retrieve back the data updated",
        // retrievedTags.size() == 2 && retrievedTags.contains("e") &&
        // retrievedTags.contains("f"));
        //
        // dao.expunge(1001l);
    }

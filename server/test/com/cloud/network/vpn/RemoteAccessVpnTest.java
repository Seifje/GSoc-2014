...
public class RemoteAccessVpnTest {
    ...
    public void testInjected() throws Exception {
        // List<Pair<String, Class<? extends RemoteAccessVPNServiceProvider>>>
        // list =
        // new ArrayList<Pair<String, Class<? extends
        // RemoteAccessVPNServiceProvider>>>();
        // list.add(new Pair<String, Class<? extends
        // RemoteAccessVPNServiceProvider>>("RemoteAccessVPNServiceProvider",
        // MockRemoteAccessVPNServiceProvider.class));
        ...
        // RemoteAccessVpnManagerImpl vpnMgr =
        // ComponentLocator.inject(RemoteAccessVpnManagerImpl.class);
        // s_logger.info("Finished inject");
        // Assert.assertTrue(vpnMgr.configure("RemoteAccessVpnMgr",new
        // HashMap<String, Object>()) );
        // Assert.assertTrue(vpnMgr.start());
        // int numProviders =
        // vpnMgr.getRemoteAccessVPNServiceProviders().size();

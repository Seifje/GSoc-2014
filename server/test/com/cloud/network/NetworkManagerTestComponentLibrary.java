...
public class NetworkManagerTestComponentLibrary {
    ...
    protected void populateManagers() {
        // addManager("configuration manager",
        ...
        // addManager("resource limit manager",
        // MockResourceLimitManagerImpl.class);
        ...
        // addManager("RemoteAccessVpnManager",
        // RemoteAccessVpnManagerImpl.class);
        ...
        // addManager("VpcVirtualRouterManager",
        // MockVpcVirtualNetworkApplianceManager.class);
        ...
        // //addManager("SecondaryStorageManager",
        // SecondaryStorageManagerImpl.class);
        // //addManager("SecurityGroupManager",
        // SecurityGroupManagerImpl2.class);
        // addManager("AgentManager", MockAgentManagerImpl.class);
        // addManager("ExternalLoadBalancerUsageManager",
        // ExternalLoadBalancerUsageManagerImpl.class);
        // //addManager("TemplateManager", TemplateManagerImpl.class);
        // //addManager("VirtualMachineManager",
        // MockVirtualMachineManagerImpl.class);

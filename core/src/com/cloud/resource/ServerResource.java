...
public interface ServerResource extends Manager {
    ...
    /**
     * disconnected() is called when the connection is down between the agent
     * and the management server. If there are any cleanups, this is the time to
     * do it.
     */
    void disconnected();

    /**
     * This is added to allow calling agent control service from within the
     * resource
     *
     * @return
     */

...
public class BackupSnapshotCommand extends SnapshotCommand {
     ...
     *            The UUID of the primary storage Pool
     ...
     * @param prevSnapshotUuid
     *            The UUID of the previous snapshot for this volume. This will
     *            be destroyed on the primary storage.
     * @param prevBackupUuid
     *            This is the UUID of the vhd file which was last backed up on
     *            secondary storage.
     * @param firstBackupUuid
     *            This is the backup of the first ever snapshot taken by the
     *            volume.
     * @param isFirstSnapshotOfRootVolume
     *            true if this is the first snapshot of a root volume. Set the
     *            parent of the backup to null.
     * @param isVolumeInactive
     *            True if the volume belongs to a VM that is not running or is
     *            detached.
     * @param secHostId
     *            This is the Id of the secondary storage.
     */

...
public interface StorageLayer extends Manager {
    ...
    /**
     * @param path
     *            path to the file to get the size.
     ...
     *
     * @param path
     *            directory or file to check if it exists.
     ...
     *
     * @param path
     *            directory that the file exists in.
     ...
     * @param rootPath
     *            delete up to this path.
     * @return true if the path is deleted and false if it is not.
     * @throws IOException
     *             if the parent has no children but delete failed.
     */

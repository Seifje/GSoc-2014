...
@APICommand(name = "modifyPool", description = "Modify pool", responseObject = ModifyVolumePoolCmdResponse.class, requestHasSensitiveInfo = false, responseHasSensitiveInfo = false)

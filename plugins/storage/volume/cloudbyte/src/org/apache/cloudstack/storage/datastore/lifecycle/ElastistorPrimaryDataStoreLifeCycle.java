...
public class ElastistorPrimaryDataStoreLifeCycle implements PrimaryDataStoreLifeCycle {
    ...
    private PrimaryDataStoreParameters createElastistorVolume(PrimaryDataStoreParameters parameters, String storagePoolName, String storageIp, Long capacityBytes,
            Long capacityIops, String protocoltype, String mountpoint) {
        ...
        try {
            ...
            CreateVolumeCmdResponse volumeCmdResponse = ElastistorUtil.createElastistorVolume(storagePoolName, tsmCmdResponse, capacityBytes, capacityIops, protocoltype,
                    mountpoint);
    ...
    private void deleteElastistorVolume(StoragePool pool) {
        ...
        // check if apikey and managentip is empty, if so getting it from
        // stragepooldetails

...
public class NetworkOfferingUsageParser {
    ...
    public static boolean parse(AccountVO account, Date startDate, Date endDate) {
        ...
        // loop through all the network offerings, create a usage record for
        // each
        for (UsageNetworkOfferingVO usageNO : usageNOs) {
            ...
            long currentDuration = (noDeleteDate.getTime() - noCreateDate.getTime()) + 1; // make sure this is an inclusive check for

...
public interface DownloadManager extends Manager {
     ...
     *            unique id.
     * @param url
     *            the url from where to download from
     * @param hvm
     *            whether the template is a hardware virtual machine
     * @param accountId
     *            the accountId of the iso owner (null if public iso)
     * @param descr
     ...
     *            (optional) max download size for the template, in bytes.
     * @param resourceType
     *            signifying the type of resource like template, volume etc.

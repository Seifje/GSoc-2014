...
public class ClientNtlmsspPubKeyAuth extends OneTimeSwitch implements NtlmConstants, Dumper {
    ...
    public ClientNtlmsspPubKeyAuth(String id, NtlmState ntlmState, SSLState sslState, String serverHostName, String targetDomain, String workstation, String user, String password) {
        super(id);
    ...
    protected void onStart() {
        ...
        /*
         * @see
         * http://blogs.msdn.com/b/openspecification/archive/2010/04/20/ntlm
         * -keys -and-sundry-stuff.aspx
         */
     ...
     * sub-field of SubjectPublicKeyInfo from the X.509 certificate, as
     * specified in [RFC3280] section 4.1. The encrypted key is encapsulated in
     * the pubKeyAuth field of the TSRequest structure and is sent over the TLS
    ...
    public static ByteBuffer generateAuthenticateMessage(NtlmState ntlmState) {
        ...
        // structure that contains the set of bit flags (section 2.2.2.5)
        // negotiated
        // in the previous messages.
        buf.writeIntLE(/* ntlmState.negotiatedFlags.value */0xe288b235); // FIXME:
        // remove
        // hardcoded
        // value
        ...
        // MsvAvTimestamp present, the client SHOULD provide a MIC(Message
        // Integrity
        // Check)
    ...
    /**
     * Write string as security buffer, using given charset, without trailing
     * '\0' character.
     */
    ...
    public static void main(String args[]) {
        ...
        // Client NEGOTIATE
        //
        byte[] clientNegotiatePacket = new byte[] { (byte) 0x30, (byte) 0x37,
                (byte) 0xa0, (byte) 0x03, (byte) 0x02, (byte) 0x01,
                (byte) 0x02, (byte) 0xa1, (byte) 0x30, (byte) 0x30,
                (byte) 0x2e, (byte) 0x30, (byte) 0x2c, (byte) 0xa0,
                (byte) 0x2a, (byte) 0x04, (byte) 0x28, (byte) 0x4e,
                (byte) 0x54, (byte) 0x4c, (byte) 0x4d, (byte) 0x53,
                (byte) 0x53, (byte) 0x50, (byte) 0x00, (byte) 0x01,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0xb7,
                (byte) 0x82, (byte) 0x08, (byte) 0xe2, (byte) 0x00,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x06,
                (byte) 0x01, (byte) 0xb1, (byte) 0x1d, (byte) 0x00,
        ...
        byte[] serverChallengePacket = new byte[] {
                ...
                (byte) 0x82,
                (byte) 0x8a,
                (byte) 0xe2, // NegotiateFlags: NEGOTIATE_56 NEGOTIATE_KEY_EXCH
                // NEGOTIATE_128 NEGOTIATE_VERSION
                // NEGOTIATE_TARGET_INFO
                // NEGOTIATE_EXTENDED_SESSION_SECURITY
                // TARGET_TYPE_SERVER NEGOTIATE_ALWAYS_SIGN
                // NEGOTIATE_NTLM NEGOTIATE_SEAL NEGOTIATE_SIGN
                // REQUEST_TARGET NEGOTIATE_UNICODE
                ...
                (byte) 0x1d, (byte) 0xea, (byte) 0x6b, (byte) 0x60,
                (byte) 0xf8, (byte) 0xc5, (byte) 0xce, (byte) 0x01, // Time: Oct
                // 10, 2013
                // 23:36:20.056937300
                // EEST
        ...
        byte[] clientAuthPacket = new byte[] {
                ...
                (byte) 0x82,
                0x03,
                0x13, // TAG: [UNIVERSAL 16] (constructed) "SEQUENCE" LEN: 787
                // bytes
                ...
                (byte) 0x82,
                0x01,
                (byte) 0xe4, // TAG: [1] (constructed) LEN: 484 bytes
                0x30,
                (byte) 0x82,
                0x01,
                (byte) 0xe0, // TAG: [UNIVERSAL 16] (constructed) "SEQUENCE"
                // LEN: 480 bytes
                0x30,
                (byte) 0x82,
                0x01,
                (byte) 0xdc, // TAG: [UNIVERSAL 16] (constructed) "SEQUENCE"
                // LEN: 476 bytes
                ...
                (byte) 0x82,
                0x01,
                (byte) 0xd8, // TAG: [0] (constructed) LEN: 472 bytes
                0x04,
                (byte) 0x82,
                0x01,
                (byte) 0xd4, // TAG: [UNIVERSAL 4] (primitive) "OCTET STRING"
                // LEN: 468 bytes
                ...
                0x00,
                0x00,
                0x00, // LmChallengeResponse (length 24, allocated: 24, offset
                // 146)
                0x1a,
                0x01,
                0x1a,
                ...
                0x00,
                0x00,
                0x00, // NtChallengeResponse (length 282, allocated: 282, offset
                // 170)
                0x12,
                0x00,
                0x12,
                ...
                0x00,
                0x00,
                0x0f, // Version (6.1, Build 7601), NTLM current revision: 15
                ...
                (byte) 0x51,
                (byte) 0xc5,
                (byte) 0x11, // Message integrity check
                ...
                // Response: HMAC_MD(ResponseKeyLM, concatenate(ServerChallenge,
                // ClientChallenge), where ResponseKeyLM=ntlmv2Hash(target,
                // user, password)
                (byte) 0x17,
                (byte) 0x9b,
                (byte) 0x7d,
                ...
                (byte) 0xc5,
                (byte) 0xce,
                (byte) 0x01, // Time: Oct 10, 2013 23:36:20.056937300 EEST
                (byte) 0x01,
                (byte) 0x02,
                (byte) 0x03,
                (byte) 0x04,
                ...
                (byte) 0x06,
                (byte) 0x07,
                (byte) 0x08, // Client challenge (fixed)
                0x00,
                0x00,
                0x00,
                0x00, // Reserved
                ...
                (byte) 0xc5,
                (byte) 0xce,
                (byte) 0x01, // Timestamp: Oct 10, 2013 23:36:20.056937300 EEST

                0x06,
                0x00, // Item Type: Flags (0x0006, LE)
                0x04,
                ...
                (byte) 0x82,
                0x01,
                0x22, // TAG: [3] (constructed) LEN: 290 bytes
                0x04,
                (byte) 0x82,
                0x01,
                0x1e, // TAG: [UNIVERSAL 4] (primitive) "OCTET STRING" LEN: 286
                // bytes

                // NTLMSSP_MESSAGE_SIGNATURE, @see
                // http://msdn.microsoft.com/en-us/library/cc422952.aspx
                ...
                // Checksum (8 bytes): An 8-byte array that contains the
                ...
                (byte) 0x15, (byte) 0xf7, (byte) 0xf2, (byte) 0x54,
                (byte) 0xda, (byte) 0xa9, (byte) 0xe5, (byte) 0xad,
                (byte) 0x85, (byte) 0x04, (byte) 0x67, (byte) 0x4d,
                (byte) 0x0b, (byte) 0xcb, (byte) 0xf9, (byte) 0xb1,
                (byte) 0xf8, (byte) 0x02, (byte) 0x8a, (byte) 0x77,
                (byte) 0xc2, (byte) 0x63, (byte) 0xab, (byte) 0xd5,
                (byte) 0x74, (byte) 0x23, (byte) 0x9f, (byte) 0x9d,
                (byte) 0x5d, (byte) 0x1f, (byte) 0xd3, (byte) 0xb3,
                (byte) 0xa0, (byte) 0xac, (byte) 0x16, (byte) 0x8a,
                (byte) 0x4b, (byte) 0x08, (byte) 0xf5, (byte) 0x47,
                (byte) 0x70, (byte) 0x58, (byte) 0x10, (byte) 0xb4,
                (byte) 0xe7, (byte) 0x87, (byte) 0xb3, (byte) 0x4b,
                (byte) 0xc9, (byte) 0xa2, (byte) 0xd5, (byte) 0xd1,
                (byte) 0xca, (byte) 0x0f, (byte) 0xd4, (byte) 0xe3,
                (byte) 0x8d, (byte) 0x76, (byte) 0x5a, (byte) 0x60,
                (byte) 0x28, (byte) 0xf8, (byte) 0x06, (byte) 0x5d,
                (byte) 0xe4, (byte) 0x7e, (byte) 0x21, (byte) 0xc8,
                (byte) 0xbb, (byte) 0xac, (byte) 0xe5, (byte) 0x79,
                (byte) 0x85, (byte) 0x30, (byte) 0x9b, (byte) 0x88,
                (byte) 0x13, (byte) 0x2f, (byte) 0x8f, (byte) 0xfc,
                (byte) 0x04, (byte) 0x52, (byte) 0xfe, (byte) 0x87,
                (byte) 0x94, (byte) 0xcf, (byte) 0xcb, (byte) 0x49,
                (byte) 0x4a, (byte) 0xda, (byte) 0x6f, (byte) 0xdd,
                (byte) 0xee, (byte) 0x57, (byte) 0xa5, (byte) 0xe4,
                (byte) 0x4d, (byte) 0x0e, (byte) 0x5c, (byte) 0x3d,
                (byte) 0x0b, (byte) 0x63, (byte) 0x1f, (byte) 0xf6,
                (byte) 0x3d, (byte) 0x1b, (byte) 0xae, (byte) 0x5a,
                (byte) 0xf6, (byte) 0x42, (byte) 0x2a, (byte) 0x46,
                (byte) 0xfa, (byte) 0x42, (byte) 0x71, (byte) 0x67,
                (byte) 0x46, (byte) 0x02, (byte) 0x71, (byte) 0xea,
                (byte) 0x51, (byte) 0x98, (byte) 0xf7, (byte) 0xd4,
                (byte) 0x43, (byte) 0xbf, (byte) 0x8e, (byte) 0xe8,
                (byte) 0x3c, (byte) 0xc8, (byte) 0xfa, (byte) 0x79,
                (byte) 0x9d, (byte) 0x8c, (byte) 0xfc, (byte) 0xc2,
                (byte) 0x42, (byte) 0xc9, (byte) 0xbb, (byte) 0xd0,
                (byte) 0xab, (byte) 0x81, (byte) 0xc4, (byte) 0x53,
                (byte) 0xfd, (byte) 0x41, (byte) 0xda, (byte) 0xab,
                (byte) 0x0f, (byte) 0x25, (byte) 0x79, (byte) 0x5f,
                (byte) 0xbd, (byte) 0xa3, (byte) 0x8c, (byte) 0xd3,
                (byte) 0xf5, (byte) 0x1b, (byte) 0xab, (byte) 0x20,
                (byte) 0xd1, (byte) 0xf4, (byte) 0xd8, (byte) 0x81,
                (byte) 0x9c, (byte) 0x18, (byte) 0x4a, (byte) 0xa4,
                (byte) 0x77, (byte) 0xee, (byte) 0xe1, (byte) 0x51,
                (byte) 0xee, (byte) 0x2a, (byte) 0xc1, (byte) 0x94,
                (byte) 0x37, (byte) 0xc5, (byte) 0x06, (byte) 0x7a,
                (byte) 0x3f, (byte) 0x0f, (byte) 0x25, (byte) 0x5b,
                (byte) 0x4e, (byte) 0x6a, (byte) 0xdc, (byte) 0x0b,
                (byte) 0x62, (byte) 0x6f, (byte) 0x12, (byte) 0x83,
                (byte) 0x03, (byte) 0xae, (byte) 0x4e, (byte) 0xce,
                (byte) 0x2b, (byte) 0x6e, (byte) 0xd4, (byte) 0xd5,
                (byte) 0x23, (byte) 0x27, (byte) 0xf6, (byte) 0xa6,
                (byte) 0x38, (byte) 0x67, (byte) 0xec, (byte) 0x95,
                (byte) 0x82, (byte) 0xc6, (byte) 0xba, (byte) 0xd4,
                (byte) 0xf6, (byte) 0xe6, (byte) 0x22, (byte) 0x7d,
                (byte) 0xb9, (byte) 0xe4, (byte) 0x81, (byte) 0x97,
                (byte) 0x24, (byte) 0xff, (byte) 0x40, (byte) 0xb2,
                (byte) 0x42, (byte) 0x3c, (byte) 0x11, (byte) 0x24,
                (byte) 0xd0, (byte) 0x3a, (byte) 0x96, (byte) 0xd9,
                (byte) 0xc1, (byte) 0x13, (byte) 0xd6, (byte) 0x62,
                (byte) 0x45, (byte) 0x21, (byte) 0x60, (byte) 0x5b,
                (byte) 0x7b, (byte) 0x2b, (byte) 0x62, (byte) 0x44,
                (byte) 0xf7, (byte) 0x40, (byte) 0x93, (byte) 0x29,
                (byte) 0x5b, (byte) 0x44, (byte) 0xb7, (byte) 0xda,
                (byte) 0x9c, (byte) 0xa6, (byte) 0xa9, (byte) 0x3b,
                (byte) 0xe1, (byte) 0x3b, (byte) 0x9d, (byte) 0x31,
                (byte) 0xf2, (byte) 0x21, (byte) 0x53, (byte) 0x0f,
                (byte) 0xb3, (byte) 0x70, (byte) 0x55, (byte) 0x84,
                (byte) 0x2c, (byte) 0xb4, };
        ...
        sslState.serverCertificateSubjectPublicKeyInfo = new byte[] {
                ...
                (byte) 0x82,
                0x01,
                0x22, // Sequence, length: 290 bytes
                0x30,
                0x0d, // Sequence, length: 13 bytes {
                0x06,
                0x09, // Object ID, length: 9 bytes
                0x2a,
                (byte) 0x86,
                0x48,
                (byte) 0x86,
                ...
                0x01,
                0x05,
                0x00, // NULL, length: 0 bytes

                (byte) 0x03,
                (byte) 0x82,
                (byte) 0x01,
                (byte) 0x0f, // Bit string, length: 271 bytes
                ...
                (byte) 0x00, (byte) 0xa8, (byte) 0x56, (byte) 0x65,
                (byte) 0xd3, (byte) 0xce, (byte) 0x8a, (byte) 0x54,
                (byte) 0x4d, (byte) 0x9d, (byte) 0xb0, (byte) 0x84,
                (byte) 0x31, (byte) 0x19, (byte) 0x71, (byte) 0x7f,
                (byte) 0xdd, (byte) 0x42, (byte) 0xfb, (byte) 0x2a,
                (byte) 0x7a, (byte) 0x72, (byte) 0x13, (byte) 0xa1,
                (byte) 0xb9, (byte) 0x72, (byte) 0xbb, (byte) 0xd3,
                (byte) 0x08, (byte) 0xad, (byte) 0x7d, (byte) 0x6c,
                (byte) 0x15, (byte) 0x65, (byte) 0x03, (byte) 0xd1,
                (byte) 0xc4, (byte) 0x54, (byte) 0xc5, (byte) 0x33,
                (byte) 0x6b, (byte) 0x7d, (byte) 0x69, (byte) 0x89,
                (byte) 0x5e, (byte) 0xfe, (byte) 0xe0, (byte) 0x01,
                (byte) 0xc0, (byte) 0x7e, (byte) 0x9b, (byte) 0xcb,
                (byte) 0x5d, (byte) 0x65, (byte) 0x36, (byte) 0xcd,
                (byte) 0x77, (byte) 0x5d, (byte) 0xf3, (byte) 0x7a,
                (byte) 0x5b, (byte) 0x29, (byte) 0x44, (byte) 0x72,
                (byte) 0xd5, (byte) 0x38, (byte) 0xe2, (byte) 0xcf,
                (byte) 0xb1, (byte) 0xc7, (byte) 0x78, (byte) 0x9b,
                (byte) 0x58, (byte) 0xb9, (byte) 0x17, (byte) 0x7c,
                (byte) 0xb7, (byte) 0xd6, (byte) 0xc7, (byte) 0xc7,
                (byte) 0xbf, (byte) 0x90, (byte) 0x4e, (byte) 0x7c,
                (byte) 0x39, (byte) 0x93, (byte) 0xcb, (byte) 0x2e,
                (byte) 0xe0, (byte) 0xc2, (byte) 0x33, (byte) 0x2d,
                (byte) 0xa5, (byte) 0x7e, (byte) 0xe0, (byte) 0x7b,
                (byte) 0xb6, (byte) 0xf9, (byte) 0x91, (byte) 0x32,
                (byte) 0xb7, (byte) 0xd4, (byte) 0x85, (byte) 0xb7,
                (byte) 0x35, (byte) 0x2d, (byte) 0x2b, (byte) 0x00,
                (byte) 0x6d, (byte) 0xf8, (byte) 0xea, (byte) 0x8c,
                (byte) 0x97, (byte) 0x5f, (byte) 0x51, (byte) 0x1d,
                (byte) 0x68, (byte) 0x04, (byte) 0x3c, (byte) 0x79,
                (byte) 0x14, (byte) 0x71, (byte) 0xa7, (byte) 0xc7,
                (byte) 0xd7, (byte) 0x70, (byte) 0x7a, (byte) 0xe0,
                (byte) 0xba, (byte) 0x12, (byte) 0x69, (byte) 0xc8,
                (byte) 0xd3, (byte) 0xd9, (byte) 0x4e, (byte) 0xab,
                (byte) 0x51, (byte) 0x47, (byte) 0xa3, (byte) 0xec,
                (byte) 0x99, (byte) 0xd4, (byte) 0x88, (byte) 0xca,
                (byte) 0xda, (byte) 0xc2, (byte) 0x7f, (byte) 0x79,
                (byte) 0x4b, (byte) 0x66, (byte) 0xed, (byte) 0x87,
                (byte) 0xbe, (byte) 0xc2, (byte) 0x5f, (byte) 0xea,
                (byte) 0xcf, (byte) 0xe1, (byte) 0xb5, (byte) 0xf0,
                (byte) 0x3d, (byte) 0x9b, (byte) 0xf2, (byte) 0x19,
                (byte) 0xc3, (byte) 0xe0, (byte) 0xe1, (byte) 0x7a,
                (byte) 0x45, (byte) 0x71, (byte) 0x12, (byte) 0x3d,
                (byte) 0x72, (byte) 0x1d, (byte) 0x6f, (byte) 0x2b,
                (byte) 0x1c, (byte) 0x46, (byte) 0x68, (byte) 0xc0,
                (byte) 0x8f, (byte) 0x4f, (byte) 0xce, (byte) 0x3a,
                (byte) 0xc5, (byte) 0xcd, (byte) 0x22, (byte) 0x65,
                (byte) 0x2d, (byte) 0x43, (byte) 0xb0, (byte) 0x5c,
                (byte) 0xdd, (byte) 0x89, (byte) 0xae, (byte) 0xbe,
                (byte) 0x70, (byte) 0x59, (byte) 0x5e, (byte) 0x0c,
                (byte) 0xbd, (byte) 0xf5, (byte) 0x46, (byte) 0x82,
                (byte) 0x1e, (byte) 0xe4, (byte) 0x86, (byte) 0x95,
                (byte) 0x7b, (byte) 0x60, (byte) 0xae, (byte) 0x45,
                (byte) 0x50, (byte) 0xc2, (byte) 0x54, (byte) 0x08,
                (byte) 0x49, (byte) 0x9a, (byte) 0x9e, (byte) 0xfb,
                (byte) 0xb2, (byte) 0xb6, (byte) 0x78, (byte) 0xe5,
                (byte) 0x2f, (byte) 0x9c, (byte) 0x5a, (byte) 0xd0,
                (byte) 0x8a, (byte) 0x03, (byte) 0x77, (byte) 0x68,
                (byte) 0x30, (byte) 0x93, (byte) 0x78, (byte) 0x6d,
                (byte) 0x90, (byte) 0x6d, (byte) 0x50, (byte) 0xfa,
                (byte) 0xa7, (byte) 0x65, (byte) 0xfe, (byte) 0x59,
                (byte) 0x33, (byte) 0x27, (byte) 0x4e, (byte) 0x4b,
                (byte) 0xf8, (byte) 0x38, (byte) 0x44, (byte) 0x3a,
                (byte) 0x12, (byte) 0xf4, (byte) 0x07, (byte) 0xa0,
                (byte) 0x8d, (byte) 0x02, (byte) 0x03, (byte) 0x01,
                (byte) 0x00, (byte) 0x01, };
        /* @formatter:on */

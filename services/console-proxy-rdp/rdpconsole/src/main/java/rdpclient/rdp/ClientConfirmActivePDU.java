...
public class ClientConfirmActivePDU extends BaseElement {
    ...
    private void sendFontListPDU() {
        {
            ...
            buf.writeBytes(new byte[] {
                    ...
                    // Channel ID: 1003 (I/O channel)
                    (byte) 0x03, (byte) 0xeb,
                    // Data priority: high (0x40), segmentation: begin (0x20) |
                    // end (0x10)
                    (byte) 0x70,
                    ...
                    (byte) 0x1a, (byte) 0x00,
                    // PDU type: PDUTYPE_DATAPDU (0x7), PDU version: 1 (0x0010)
                    // (LE)
                    (byte) 0x17, (byte) 0x00,
                    // PDU source: 1004 (LE)
                    (byte) 0xec, (byte) 0x03, });
            ...
            buf.writeBytes(new byte[] {
                    ...
                    (byte) 0x00, (byte) 0x00,
                    // listFlags (should be set to 0x3): 0x0003 (LE),
                    // FONTLIST_LAST(0x2) | FONTLIST_FIRST(0x1)
                    (byte) 0x03, (byte) 0x00,
    ...
    private void sendControlPDUActionRequestControl() {
        ...
        buf.writeBytes(new byte[] {
                ...
                // Channel ID: 1003 (I/O channel)
                (byte) 0x03, (byte) 0xeb,
                // Data priority: high (0x40), segmentation: begin (0x20) | end
                // (0x10)
                (byte) 0x70,
                // User data length: 26 bytes (0x1a, variable length field)
                (byte) 0x80, (byte) 0x1a,
    ...
    private void sendSynchronizePDU() {
        ...
        buf.writeBytes(new byte[] {
                ...
                // PDU type: PDUTYPE_DATAPDU (0x7), TS_PROTOCOL_VERSION (0x10)
                // (LE)
                (byte) 0x17, (byte) 0x00,
    ...
    private void writeBrushCS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x0f, (byte)0x00, // capability set type: CAPSTYPE_BRUSH
                // (15,
                // LE)
                (byte)0x08, (byte)0x00, // length of capability set: 8 bytes
                // (LE)
    ...
    private void writeInputCS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x35,
                (byte)0x00, // inputFlags: 0x0035 (LE),
                ...
                (byte)0x04,
                (byte)0x00,
                (byte)0x00, // keyboardLayout: "US" keyboard layout (0x000409,
                // LE)
                (byte)0x00,
                (byte)0x00,
                (byte)0x00,
                ...
                // imeFileName: "", (64 bytes, including trailing NULL
                // characters, UCS2)
    ...
    private void writeShareCS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x09, (byte)0x00, // capability set type: CAPSTYPE_SHARE
                // (9, LE)
                (byte)0x08, (byte)0x00, // length of capability set: 8 bytes
                // (LE)
                (byte)0x00, (byte)0x00, // nodeID (must be set to 0 by
                // client): 0 (LE)
    ...
    private void writePointerCS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x08, (byte)0x00, // capability set type:
                // CAPSTYPE_POINTER (8,
                // LE)
                (byte)0x0a, (byte)0x00, // length of capability set: 10 bytes
                // (LE)
    ...
    private void writeControlCS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x05, (byte)0x00, // capability set type:
                // CAPSTYPE_ACTIVATION
                // (7)
                (byte)0x0c, (byte)0x00, // length of capability set: 12 bytes
                // (LE)
                (byte)0x00, (byte)0x00, // controlFlags (should be set to 0):
                // 0 (LE)
                (byte)0x00, (byte)0x00, // remoteDetachFlag (should be set to
                // 0): 0
                // (LE)
    ...
    private void writeWindowActivationCS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x07, (byte)0x00, // capability set type:
                // CAPSTYPE_ACTIVATION
                // (7) (LE)
                (byte)0x0c, (byte)0x00, // length of capability set: 12 bytes
                // (LE)
                (byte)0x00, (byte)0x00, // helpKeyFlag (should be set to FALSE
                // (0)):
                // FALSE (0, LE)
                (byte)0x00, (byte)0x00, // helpKeyIndexFlag (should be set to
                // FALSE
                // (0)): FALSE (0, LE)
                (byte)0x00, (byte)0x00, // helpExtendedKeyFlag (should be set
                // to FALSE
                // (0)): FALSE (0, LE)
                (byte)0x00, (byte)0x00, // windowManagerKeyFlag (should be set
        // to
        // FALSE (0)): FALSE (0, LE)
    ...
    private void writeColorTableCacheCS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x0a, (byte)0x00, // capability set type:
                // CAPSTYPE_COLORCACHE
                // (10) (LE)
                (byte)0x08, (byte)0x00, // length of capability set: 8 bytes
                // (LE)
                (byte)0x06, (byte)0x00, // Color table cache size (must be
                // ignored
    ...
    private void writeBitmapCache2CS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x28, (byte)0x00, // length of capability set: 40 bytes
                // (LE)
                (byte)0x00, (byte)0x00, // Cache flags: 0 (LE)
                (byte)0x00, // Padding 1 byte
                (byte)0x00, // Number of cell caches: 0
                (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, // Bitmap
                // cache0
                // cell info: 0 (LE)
                (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, // Bitmap
                // cache1
    ...
    private void writeGeneralCS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x01, (byte)0x00, // capability set type:
                // CAPSTYPE_GENERAL (1)
                // (LE)
                (byte)0x18, (byte)0x00, // length of capability set: 24 bytes
                // (LE)
                (byte)0x01, (byte)0x00, // TS_OSMAJORTYPE_WINDOWS (1) (LE)
                (byte)0x03, (byte)0x00, // TS_OSMINORTYPE_WINDOWS_NT (3) (LE)
                (byte)0x00, (byte)0x02, // TS_CAPS_PROTOCOLVERSION (0x0200)
                // (LE)
                (byte)0x00, (byte)0x00, // Padding 2 bytes
                (byte)0x00, (byte)0x00, // generalCompressionTypes: 0 (LE)

                // Extra flags: 0x040d (LE)
                // FastPathOutput: (...............1) Advertiser supports
                // fast-path
                // output
                // ShadowCompression: (..............0.) Advertiser NOT supports
                // shadow
                // compression
                // LongLengthCredentials: (.............1..) Advertiser supports
                // long-length credentials for the user name, password, or
                // domain name
                // SessionAutoreconnection: (............1...) Advertiser
                // supports
                // session auto-reconnection
                // ImprovedEncryptionChecksum: (...........0....) Client and
                // server NOT
                // support improved encryption checksum
                // Reserved1: (......00000.....)
                // CompressedBitMapDataFlag: (.....1..........) No 8-UINT8
                // header is
    ...
    private void writeBitmapCS(ByteBuffer buf) {
        ...
        // receive1BitPerPixel (ignored and SHOULD be set to TRUE (0x1)): TRUE
        // (0x1) (LE)
        buf.writeShortLE(1);

        // receive4BitsPerPixel (ignored and SHOULD be set to TRUE (0x1)): TRUE
        // (0x1) (LE)
        buf.writeShortLE(1);

        // receive8BitsPerPixel (ignored and SHOULD be set to TRUE (0x1)): TRUE
        // (0x1) (LE)
        buf.writeShortLE(1);
        ...
        buf.writeBytes(new byte[] {(byte)0x01, (byte)0x00, // bitmapCompressionFlag
                // (must be set to
                // TRUE
                // (0x1)): TRUE (0x1) (LE)
                (byte)0x00, // highColorFlags (field is ignored and SHOULD be
                // set to
                // zero): 0
    ...
    private void writeOrderCS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x01, (byte)0x00, // desktopSaveXGranularity (ignored):
                // 1 (LE)
                (byte)0x14, (byte)0x00, // desktopSaveYGranularity (ignored):
                // 20 (LE)
                (byte)0x00, (byte)0x00, // pad2octetsA (ignored)
                (byte)0x01, (byte)0x00, // maximumOrderLevel:
                ...
                // Order support: 32 bytes (no primary drawing orders are
                // supported, so
                // this array MUST be initialized to all zeros, use 0x01 for
                // TRUE).
                ...
                (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, // Padding 4
                // bytes
                (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, // Desktop
                // save size
                // (ignored): 0
                // (assumed to be
                // 230400 bytes
                ...
                (byte)0x00, (byte)0x00, // Padding 2 bytes
                (byte)0x00, (byte)0x00, // Padding 2 bytes
                (byte)0xe4, (byte)0x04, // Text ANSI Code Page: 1252, ANSI -
                // Latin I
                // (0x04e4, LE)
                (byte)0x00, (byte)0x00, // Padding 2 bytes
    ...
    private void writeSoundCS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x0c, (byte)0x00, // capability set type: CAPSTYPE_SOUND
                // (12,
                // LE)
                (byte)0x08, (byte)0x00, // length of capability set: 8 bytes
                // (LE)
    ...
    private void writeGlyphCacheCS(ByteBuffer buf) {
        ...
        buf.writeBytes(new byte[] {
                ...
                (byte)0x34, (byte)0x00, // length of capability set: 52 bytes
                // (LE)
    ...
    public static void main(String args[]) {
        ...
        byte[] packet = new byte[] {
                ...
                // PDU type: Confirm Active PDU (0x3), TS_PROTOCOL_VERSION
                // (0x10) (LE)
                (byte) 0x13,
                (byte) 0x00,
                ...
                // Length of source descriptor: 6 bytes (including NULL
                // character) (LE)
                (byte) 0x06,
                (byte) 0x00,
                ...
                // http://msdn.microsoft.com/en-us/library/cc240549.aspx
                (byte) 0x01,
                (byte) 0x00, // capability set type: CAPSTYPE_GENERAL (1) (LE)
                (byte) 0x18,
                ...
                (byte) 0x00,
                (byte) 0x02, // TS_CAPS_PROTOCOLVERSION (0x0200) (LE)
                (byte) 0x00,
                (byte) 0x00, // Padding 2 bytes
                (byte) 0x00,
                ...
                // domain name
                // SessionAutoreconnection: (............1...) Advertiser
                // supports session auto-reconnection
                // ImprovedEncryptionChecksum: (...........0....) Client and
                // server NOT support improved encryption checksum
                // Reserved1: (......00000.....)
                // CompressedBitMapDataFlag: (.....1..........) No 8-UINT8
                // header is present for compressed bitmap data
                // Reserved2: (00000...........)
                (byte) 0x0d,
                (byte) 0x04,
                ...
                (byte) 0x01,
                (byte) 0x00, // receive1BitPerPixel (ignored and SHOULD be set
                // to TRUE (0x1)): TRUE (0x1) (LE)
                (byte) 0x01,
                (byte) 0x00, // receive4BitsPerPixel (ignored and SHOULD be set
                // to TRUE (0x1)): TRUE (0x1) (LE)
                (byte) 0x01,
                (byte) 0x00, // receive8BitsPerPixel (ignored and SHOULD be set
                // to TRUE (0x1)): TRUE (0x1) (LE)
                (byte) 0x00,
                (byte) 0x04, // desktopWidth = 1024 pixels (LE)
                (byte) 0x00,
                (byte) 0x03, // desktopHeight = 768 pixels (LE)
                (byte) 0x00,
                (byte) 0x00, // Padding 2 bytes
                (byte) 0x00,
                (byte) 0x00, // desktopResizeFlag: FALSE (0x0) (LE)
                (byte) 0x01,
                (byte) 0x00, // bitmapCompressionFlag (must be set to TRUE
                // (0x1)): TRUE (0x1) (LE)
                (byte) 0x00, // highColorFlags (field is ignored and SHOULD be
                // set to zero): 0
                (byte) 0x01, // drawingFlags: 0x1 TODO: padding, why 0x1 ???
                (byte) 0x01,
                (byte) 0x00, // multipleRectangleSupport: TRUE (LE)
                (byte) 0x00,
                (byte) 0x00, // Padding 2 bytes
                ...
                (byte) 0x4a,
                (byte) 0x00, // orderFlags = 0x004a (LE), SOLIDPATTERNBRUSHONLY
                // (0x40), ZEROBOUNDSDELTASSUPPORT (0x8, MUST),
                // NEGOTIATEORDERSUPPORT (0x2, MUST)
                // Order support: 32 bytes (no primary drawing orders are
                // supported, so this array MUST be initialized to all zeros,
                // use 0x01 for TRUE).
                (byte) 0x00, // TS_NEG_DSTBLT_INDEX: FALSE
                (byte) 0x00, // TS_NEG_PATBLT_INDEX: FALSE
                (byte) 0x00, // TS_NEG_SCRBLT_INDEX: FALSE
                ...
                (byte) 0x00,
                (byte) 0x00,
                (byte) 0x00, // Desktop save size (ignored): 0 (assumed to be
                // 230400 bytes (480*480, 0x38400, LE))
                (byte) 0x00,
                (byte) 0x00, // Padding 2 bytes
                (byte) 0x00,
                (byte) 0x00, // Padding 2 bytes
                (byte) 0xe4,
                (byte) 0x04, // Text ANSI Code Page: 1252, ANSI - Latin I
                // (0x04e4, LE)
                (byte) 0x00,
                (byte) 0x00, // Padding 2 bytes
                ...
                // http://msdn.microsoft.com/en-us/library/cc240560.aspx
                (byte) 0x13,
                (byte) 0x00, // capability set type: CAPSTYPE_BITMAPCACHE_REV2
                // (19) (LE)
                (byte) 0x28,
                ...
                // http://msdn.microsoft.com/en-us/library/cc241564.aspx
                (byte) 0x0a,
                (byte) 0x00, // capability set type: CAPSTYPE_COLORCACHE (10)
                // (LE)
                (byte) 0x08,
                (byte) 0x00, // length of capability set: 8 bytes (LE)
                (byte) 0x06,
                (byte) 0x00, // Color table cache size (must be ignored during
                // capability exchange and is assumed to be
                // 0x0006): 6 (LE)
                (byte) 0x00,
                (byte) 0x00, // Padding 2 bytes
                ...
                (byte) 0x00,
                (byte) 0x00, // helpKeyFlag (should be set to FALSE (0)): FALSE
                // (0, LE)
                (byte) 0x00,
                (byte) 0x00, // helpKeyIndexFlag (should be set to FALSE (0)):
                // FALSE (0, LE)
                (byte) 0x00,
                (byte) 0x00, // helpExtendedKeyFlag (should be set to FALSE
                // (0)): FALSE (0, LE)
                (byte) 0x00,
                (byte) 0x00, // windowManagerKeyFlag (should be set to FALSE
                // (0)): FALSE (0, LE)
                ...
                (byte) 0x02,
                (byte) 0x00, // controlInterest (should be set to
                // CONTROLPRIORITY_NEVER): CONTROLPRIORITY_NEVER
                // (2) (LE)
                (byte) 0x02,
                (byte) 0x00, // detachInterest (should be set to
                // CONTROLPRIORITY_NEVER): CONTROLPRIORITY_NEVER
                // (2) (LE)
                ...
                // INPUT_FLAG_VKPACKET (0x10), INPUT_FLAG_MOUSEX
                // (0x4), INPUT_FLAG_SCANCODES (0x1)
                (byte) 0x00,
                (byte) 0x00, // Padding 2 bytes
                (byte) 0x09,
                ...
                // http://msdn.microsoft.com/en-us/library/cc240564.aspx
                (byte) 0x0f,
                (byte) 0x00, // capability set type: CAPSTYPE_BRUSH (15, LE)
                (byte) 0x08,
                (byte) 0x00, // length of capability set: 8 bytes (LE)
                (byte) 0x00, (byte) 0x00,
                (byte) 0x00,
                ...
                (byte) 0x00, (byte) 0x00,
                (byte) 0x00,
                (byte) 0x00, // soundFlags: 0x0000 (LE) // SOUND_FLAG_BEEPS
                // (0x1)

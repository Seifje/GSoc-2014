...
public class ClientInfoPDU extends OneTimeSwitch {
    ...
    protected byte[] password = "".getBytes(RdpConstants.CHARSET_16); // No
    // effect
    ...
    protected void onStart() {
        ...
        // Data priority: high, segmentation: begin | end (0x40 | 0x20 | 0x10 =
        // 0x70)
        buf.writeByte(0x70);
        ...
        // cbDomain length: 0 bytes (LE) (NOT including size of mandatory NULL
        // terminator)
        buf.writeShortLE(domain.length);

        // cbUserName length: 16 bytes (0x10, LE) (NOT including size of
        // mandatory NULL terminator)
        buf.writeShortLE(userName.length);

        // cbPassword length: (LE) (NOT including size of mandatory NULL
        // terminator)
        buf.writeShortLE(password.length);

        // cbAlternateShell: (LE) (NOT including size of mandatory NULL
        // terminator)
        ...
        // cbClientAddress: ( LE) (including the size of the mandatory NULL
        // terminator)
        ...
        // cbClientDir: 64 bytes (0x40, LE) (including the size of the mandatory
        // NULL terminator)
        ...
        // Performance flags: 0x7 (LE) = PERF_DISABLE_WALLPAPER (0x1),
        // PERF_DISABLE_FULLWINDOWDRAG (0x2), PERF_DISABLE_MENUANIMATIONS (0x4)
    ...
    public static void main(String args[]) {
        ...
        byte[] packet = new byte[] {
                ...
                // Data priority: high, segmentation: begin | end (0x40 | 0x20 |
                // 0x10 = 0x70)
                (byte) 0x70,
                ...
                // Codepage: 0 (UNKNOWN, LE) (use 0x04090409 (1033,1033) for
                // EN_US)
                (byte) 0x00,
                (byte) 0x00,
                (byte) 0x00,
                ...
                // Flags: 0xa0173 (LE), INFO_MOUSE (0x1), INFO_DISABLECTRLALTDEL
                // (0x2), INFO_UNICODE (0x10),
                // INFO_MAXIMIZESHELL (0x20), INFO_LOGONNOTIFY (0x40),
                // INFO_ENABLEWINDOWSKEY (0x100),
                // INFO_MOUSE_HAS_WHEEL (0x00020000), INFO_NOAUDIOPLAYBACK
                // (0x00080000),
                (byte) 0x73,
                (byte) 0x01,
                (byte) 0x0a,
                ...
                // cbDomain length: 0 bytes (LE) (NOT including size of
                // mandatory NULL terminator)
                (byte) 0x00,
                (byte) 0x00,
                ...
                // cbPassword length: 0 bytes (LE) (NOT including size of
                // mandatory NULL terminator)
                (byte) 0x00,
                (byte) 0x00,

                // cbAlternateShell: 0 bytes (LE) (NOT including size of
                // mandatory NULL terminator)
                (byte) 0x00,
                (byte) 0x00,

                // cbWorkingDir: 0 bytes (LE) (NOT including size of mandatory
                // NULL terminator)
                (byte) 0x00,
                (byte) 0x00,
                ...
                // cbClientAddress = 28 bytes (0x1c, LE) (including the size of
                ...
                // cbClientDir: 64 bytes (0x40, LE) (including the size of the
                // mandatory NULL terminator)
                (byte) 0x40,
                (byte) 0x00,
                ...
                // Standard name: "EET, Standard Time" (fixed string: 64 bytes,
                // UCS2)
                (byte) 0x45,
                (byte) 0x00,
                (byte) 0x45,
                ...
                // Daylight name: "EET, Summer Time" (fixed string: 64 bytes,
                // UCS2)
                (byte) 0x45, (byte) 0x00, (byte) 0x45, (byte) 0x00,
                (byte) 0x54, (byte) 0x00, (byte) 0x2c, (byte) 0x00,
                ...
                (byte) 0x54, (byte) 0x00, (byte) 0x69, (byte) 0x00,
                (byte) 0x6d, (byte) 0x00, (byte) 0x65, (byte) 0x00,
                ...
                // Performance flags: 0x7 (LE) = PERF_DISABLE_WALLPAPER (0x1),
                // PERF_DISABLE_FULLWINDOWDRAG (0x2),
                // PERF_DISABLE_MENUANIMATIONS (0x4)

...
public class ServerDemandActivePDU extends BaseElement {
    ...
    public void handleData(ByteBuffer buf, Link link) {
        ...
        // (2 bytes): A 16-bit, unsigned integer. The combined size in bytes of
        // the
        ...
        // (4 bytes): A 32-bit, unsigned integer. The session identifier. This
        // field
    ...
    protected void handleCapabiltySets(ByteBuffer buf) {
        ...
        for (int i = 0; i < numberCapabilities; i++) {
            ...
            // (variable): Capability set data which conforms to the structure
            // of the
    ...
    protected void handleBitmapCapabilities(ByteBuffer buf) {
        ...
        // (2 bytes): A 16-bit, unsigned integer. The server MUST set this field
        // to
        // the color depth of the session, while the client SHOULD set this
        // field to
        // the color depth requested in the Client Core Data (section
        // 2.2.1.3.2).
        ...
        // whether the client can receive 1 bpp. This field is ignored and
        // SHOULD be
        // set to TRUE (0x0001).
        buf.skipBytes(2);

        // receive4BitsPerPixel(2 bytes): A 16-bit, unsigned integer. Indicates
        // whether the client can receive 4 bpp. This field is ignored and
        // SHOULD be
        // set to TRUE (0x0001).
        buf.skipBytes(2);

        // receive8BitsPerPixel (2 bytes): A 16-bit, unsigned integer. Indicates
        // whether the client can receive 8 bpp. This field is ignored and
        // SHOULD be
        // set to TRUE (0x0001).
        buf.skipBytes(2);

        // (2 bytes): A 16-bit, unsigned integer. The width of the desktop in
        // the
        // session.
        int desktopWidth = buf.readUnsignedShortLE();

        // (2 bytes): A 16-bit, unsigned integer. The height of the desktop in
        // the
        // session.
        ...
        // bitmapCompressionFlag (2 bytes): A 16-bit, unsigned integer.
        // Indicates
        // whether bitmap compression is supported. This field MUST be set to
        // TRUE
        // (0x0001) because support for compressed bitmaps is required for a
        // connection to proceed.

        // highColorFlags (1 byte): An 8-bit, unsigned integer. Client support
        // for
        ...
        // multipleRectangleSupport (2 bytes): A 16-bit, unsigned integer.
        // Indicates
        // whether the use of multiple bitmap rectangles is supported in the
        // Bitmap
        // Update (section 2.2.9.1.1.3.1.2). This field MUST be set to TRUE
        // (0x0001)
    ...
    public static void main(String args[]) {
        ...
        byte[] packet = new byte[] {
                0x67,
                0x01, // TS_SHARECONTROLHEADER::totalLength = 0x0167 = 359 bytes
                0x11,
                0x00, // TS_SHARECONTROLHEADER::pduType = 0x0011 0x0011 = 0x0010
                // | 0x0001 = TS_PROTOCOL_VERSION |
                // PDUTYPE_DEMANDACTIVEPDU

                (byte) 0xea,
                0x03, // TS_SHARECONTROLHEADER::pduSource = 0x03ea (1002)

                (byte) 0xea,
                0x03,
                0x01,
                0x00, // TS_DEMAND_ACTIVE_PDU::shareId
                0x04,
                0x00, // TS_DEMAND_ACTIVE_PDU::lengthSourceDescriptor = 4 bytes
                0x51,
                0x01, // TS_DEMAND_ACTIVE_PDU::lengthCombinedCapabilities =
                // 0x151 = 337 bytes

                0x52,
                0x44,
                0x50,
                0x00, // TS_DEMAND_ACTIVE_PDU::sourceDescriptor = "RDP"
                ...
                // 0x09, 0x00, 0x08, 0x00, (byte) 0xea, 0x03, (byte) 0xdc,
                // (byte) 0xe2,
                //
                0x09,
                0x00, // TS_SHARE_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_SHARE (9)
                0x08,
                0x00, // TS_SHARE_CAPABILITYSET::lengthCapability = 8 bytes
                (byte) 0xea,
                0x03, // TS_SHARE_CAPABILITYSET::nodeID = 0x03ea (1002)
                (byte) 0xdc,
                (byte) 0xe2, // TS_SHARE_CAPABILITYSET::pad2octets

                // General Capability Set (24 bytes)
                // 0x01, 0x00, 0x18, 0x00, 0x01, 0x00, 0x03, 0x00, 0x00, 0x02,
                // 0x00, 0x00, 0x00, 0x00, 0x1d, 0x04,
                // 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01,
                //
                0x01,
                0x00, // TS_GENERAL_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_GENERAL (1)
                0x18,
                0x00, // TS_GENERAL_CAPABILITYSET::lengthCapability = 24 bytes

                0x01,
                0x00, // TS_GENERAL_CAPABILITYSET::osMajorType =
                // TS_OSMAJORTYPE_WINDOWS (1)
                0x03,
                0x00, // TS_GENERAL_CAPABILITYSET::osMinorType =
                // TS_OSMINORTYPE_WINDOWS_NT (3)
                0x00,
                0x02, // TS_GENERAL_CAPABILITYSET::protocolVersion =
                ...
                0x1d,
                0x04, // TS_GENERAL_CAPABILITYSET::extraFlags = 0x041d = 0x0400
                // | 0x0010 | 0x0008 | 0x0004 | 0x0001 =
                // NO_BITMAP_COMPRESSION_HDR | ENC_SALTED_CHECKSUM |
                // AUTORECONNECT_SUPPORTED | LONG_CREDENTIALS_SUPPORTED |
                ...
                //
                0x14,
                0x00, // TS_VIRTUALCHANNEL_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_VIRTUALCHANNEL (20)
                0x08,
                0x00, // TS_VIRTUALCHANNEL_CAPABILITYSET::lengthCapability = 8
                // bytes

                0x02,
                0x00,
                0x00,
                0x00, // TS_VIRTUALCHANNEL_CAPABILITYSET::vccaps1 = 0x00000002 =
                // VCCAPS_COMPR_CS_8K

                // DrawGdiPlus Capability Set (40 bytes)
                // 0x16, 0x00, 0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x70, (byte)
                // 0xf6, 0x13, (byte) 0xf3, 0x01, 0x00, 0x00, 0x00,
                // 0x01, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, (byte) 0x9c,
                // (byte) 0xf6, 0x13, (byte) 0xf3, 0x61, (byte) 0xa6, (byte)
                // 0x82, (byte) 0x80,
                // 0x00, 0x00, 0x00, 0x00, 0x00, 0x50, (byte) 0x91, (byte) 0xbf,
                //
                0x16,
                0x00, // TS_DRAW_GDIPLUS_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_DRAWGDIPLUS (22)
                0x28,
                0x00, // TS_DRAW_GDIPLUS_CAPABILITYSET::lengthCapability = 40
                // bytes

                0x00,
                0x00,
                0x00,
                0x00, // TS_DRAW_GDIPLUS_CAPABILITYSET::drawGdiplusSupportLevel
                // = TS_DRAW_GDIPLUS_DEFAULT (0)
                0x70,
                (byte) 0xf6,
                0x13,
                (byte) 0xf3, // TS_DRAW_GDIPLUS_CAPABILITYSET::GdipVersion (not
                // initialized by server)
                0x01,
                0x00,
                0x00,
                0x00, // TS_DRAW_GDIPLUS_CAPABILITYSET::drawGdiplusCacheLevel =
                // TS_DRAW_GDIPLUS_CACHE_LEVEL_ONE (1)

                0x01,
                0x00, // TS_GDIPLUS_CACHE_ENTRIES::GdipGraphicsCacheEntries (not
                // initialized by server)
                0x00,
                0x00, // TS_GDIPLUS_CACHE_ENTRIES::GdipObjectBrushCacheEntries
                // (not initialized by server)
                0x18,
                0x00, // TS_GDIPLUS_CACHE_ENTRIES::GdipObjectPenCacheEntries
                // (not initialized by server)
                0x00,
                0x00, // TS_GDIPLUS_CACHE_ENTRIES::GdipObjectImageCacheEntries
                // (not initialized by server)
                (byte) 0x9c,
                (byte) 0xf6, // TS_GDIPLUS_CACHE_ENTRIES::GdipObjectImageAttributesCacheEntries
                // (not initialized by server)

                0x13,
                (byte) 0xf3, // TS_GDIPLUS_CACHE_CHUNK_SIZE::GdipGraphicsCacheChunkSize
                // (not initialized by server)
                0x61,
                (byte) 0xa6, // TS_GDIPLUS_CACHE_CHUNK_SIZE::GdipObjectBrushCacheChunkSize
                // (not initialized by server)
                (byte) 0x82,
                (byte) 0x80, // TS_GDIPLUS_CACHE_CHUNK_SIZE::GdipObjectPenCacheChunkSize
                // (not initialized by server)
                0x00,
                0x00, // TS_GDIPLUS_CACHE_CHUNK_SIZE::GdipObjectImageAttributesCacheChunkSize
                // (not initialized by server)

                0x00,
                0x00, // TS_GDIPLUS_IMAGE_CACHE_PROPERTIES::GdipObjectImageCacheChunkSize
                // (not initialized by server)
                0x00,
                0x50, // TS_GDIPLUS_IMAGE_CACHE_PROPERTIES::GdipObjectImageCacheTotalSize
                // (not initialized by server)
                (byte) 0x91,
                (byte) 0xbf, // TS_GDIPLUS_IMAGE_CACHE_PROPERTIES::GdipObjectImageCacheMaxSize
                // (not initialized by server)

                // Font Capability Set (4 bytes)
                // 0x0e, 0x00, 0x04, 0x00,
                //
                // Due to a bug, the TS_FONT_CAPABILITYSET capability set size
                // is incorrectly set to 4 bytes (it must be 8 bytes). As a
                // result of this bug, the fontSupportFlags and pad2octets
                // fields are missing.
                0x0e,
                0x00, // TS_FONT_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_FONT (14)
                0x04,
                0x00, // TS_FONT_CAPABILITYSET::lengthCapability = 4 bytes

                // Bitmap Capability Set (28 bytes)
                // 0x02, 0x00, 0x1c, 0x00, 0x18, 0x00, 0x01, 0x00, 0x01, 0x00,
                // 0x01, 0x00, 0x00, 0x05, 0x00, 0x04,
                // 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00,
                // 0x00, 0x00,
                //
                0x02,
                0x00, // TS_BITMAP_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_BITMAP (2)
                0x1c,
                ...
                0x00,
                0x05, // TS_BITMAP_CAPABILITYSET::desktopWidth = 1280 pixels
                0x00,
                0x04, // TS_BITMAP_CAPABILITYSET::desktopHeight = 1024 pixels
                0x00,
                ...
                0x01,
                0x00, // TS_BITMAP_CAPABILITYSET::multipleRectangleSupport =
                // TRUE
                0x00,
                ...
                // 0x00, 0x00, 0x00, 0x00, 0x40, 0x42, 0x0f, 0x00, 0x01, 0x00,
                // 0x14, 0x00, 0x00, 0x00, 0x01, 0x00,
                // 0x00, 0x00, 0x22, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00,
                // 0x00, 0x01, 0x01, 0x01, 0x01, 0x01,
                // 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
                // 0x01, 0x00, 0x01, 0x01, 0x01, 0x01,
                // 0x00, 0x00, 0x00, 0x00, (byte) 0xa1, 0x06, 0x00, 0x00, 0x40,
                // 0x42, 0x0f, 0x00, 0x40, 0x42, 0x0f, 0x00,
                // 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                //
                0x03,
                0x00, // TS_ORDER_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_ORDER (3)
                0x58,
                ...
                0x01,
                0x00, // TS_ORDER_CAPABILITYSET::maximumOrderLevel =
                // ORD_LEVEL_1_ORDERS (1)
                0x00,
                0x00, // TS_ORDER_CAPABILITYSET::numberFonts = 0

                0x22,
                0x00, // TS_ORDER_CAPABILITYSET::orderFlags = 0x0022 = 0x0020 |
                // 0x0002 = COLORINDEXSUPPORT | NEGOTIATEORDERSUPPORT

                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_DSTBLT_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_PATBLT_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_SCRBLT_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_MEMBLT_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_MEM3BLT_INDEX]
                // = TRUE
                0x00, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_ATEXTOUT_INDEX]
                // = FALSE
                0x00, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_AEXTTEXTOUT_INDEX]
                // = FALSE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_DRAWNINEGRID_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_LINETO_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_MULTI_DRAWNINEGRID_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_OPAQUERECT_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_SAVEBITMAP_INDEX]
                // = TRUE
                0x00, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_WTEXTOUT_INDEX]
                // = FALSE
                0x00, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_MEMBLT_R2_INDEX]
                // = FALSE
                0x00, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_MEM3BLT_R2_INDEX]
                // = FALSE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_MULTIDSTBLT_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_MULTIPATBLT_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_MULTISCRBLT_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_MULTIOPAQUERECT_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_FAST_INDEX_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_POLYGON_SC_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_POLYGON_CB_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_POLYLINE_INDEX]
                // = TRUE
                0x00, // TS_ORDER_CAPABILITYSET::orderSupport[23] = 0
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_FAST_GLYPH_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_ELLIPSE_SC_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_ELLIPSE_CB_INDEX]
                // = TRUE
                0x01, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_INDEX_INDEX]
                // = TRUE
                0x00, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_WEXTTEXTOUT_INDEX]
                // = FALSE
                0x00, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_WLONGTEXTOUT_INDEX]
                // = FALSE
                0x00, // TS_ORDER_CAPABILITYSET::orderSupport[TS_NEG_WLONGEXTTEXTOUT_INDEX]
                // = FALSE
                0x00, // TS_ORDER_CAPABILITYSET::orderSupport[24] = 0

                (byte) 0xa1,
                0x06, // TS_ORDER_CAPABILITYSET::textFlags = 0x06a1
                ...
                0x42,
                0x0f,
                0x00, // TS_ORDER_CAPABILITYSET::desktopSaveSize = 0xf4240 =
                // 1000000
                0x01,
                ...
                //
                0x0a,
                0x00, // TS_COLORTABLECACHE_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_COLORCACHE (10)
                0x08,
                0x00, // TS_COLORTABLECACHE_CAPABILITYSET::lengthCapability = 8
                // bytes

                0x06,
                0x00, // TS_COLORTABLECACHE_CAPABILITYSET::colorTableCacheSize =
                // 6
                0x00,
                ...
                //
                0x12,
                0x00, // TS_BITMAPCACHE_CAPABILITYSET_HOSTSUPPORT::capabilitySetType
                // = CAPSTYPE_BITMAPCACHE_HOSTSUPPORT (18)
                0x08,
                0x00, // TS_BITMAPCACHE_CAPABILITYSET_HOSTSUPPORT::lengthCapability
                // = 8 bytes

                0x01, // TS_BITMAPCACHE_CAPABILITYSET_HOSTSUPPORT::CacheVersion
                // = 1 (corresponds to rev. 2 capabilities)
                ...
                //
                0x08,
                0x00, // TS_POINTER_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_POINTER (8)
                0x0a,
                ...
                // 0x0d, 0x00, 0x58, 0x00, 0x35, 0x00, 0x00, 0x00, (byte) 0xa1,
                // 0x06, 0x00, 0x00, 0x40, 0x42, 0x0f, 0x00,
                // 0x0c, (byte) 0xf6, 0x13, (byte) 0xf3, (byte) 0x93, 0x5a,
                // 0x37, (byte) 0xf3, 0x00, (byte) 0x90, 0x30, (byte) 0xe1,
                // 0x34, 0x1c, 0x38, (byte) 0xf3,
                // 0x40, (byte) 0xf6, 0x13, (byte) 0xf3, 0x04, 0x00, 0x00, 0x00,
                // 0x4c, 0x54, (byte) 0xdc, (byte) 0xe2, 0x08, 0x50, (byte)
                // 0xdc, (byte) 0xe2,
                // 0x01, 0x00, 0x00, 0x00, 0x08, 0x50, (byte) 0xdc, (byte) 0xe2,
                // 0x00, 0x00, 0x00, 0x00, 0x38, (byte) 0xf6, 0x13, (byte) 0xf3,
                // 0x2e, 0x05, 0x38, (byte) 0xf3, 0x08, 0x50, (byte) 0xdc,
                // (byte) 0xe2, 0x2c, (byte) 0xf6, 0x13, (byte) 0xf3, 0x00,
                // 0x00, 0x00, 0x00,
                // 0x08, 0x00, 0x0a, 0x00, 0x01, 0x00, 0x19, 0x00,
                //
                0x0d,
                0x00, // TS_INPUT_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_INPUT (13)
                0x58,
                0x00, // TS_INPUT_CAPABILITYSET::lengthCapability = 88 bytes

                0x35,
                0x00, // TS_INPUT_CAPABILITYSET::inputFlags = 0x0035 = 0x0020 |
                // 0x0010 | 0x0004 | 0x0001 = INPUT_FLAG_FASTPATH_INPUT2 |
                // INPUT_FLAG_VKPACKET | INPUT_FLAG_MOUSEX |
                ...
                0x06,
                0x00,
                0x00, // TS_INPUT_CAPABILITYSET::keyboardLayout (not initialized
                // by server)
                0x40,
                0x42,
                0x0f,
                0x00, // TS_INPUT_CAPABILITYSET::keyboardType (not initialized
                // by server)
                0x0c,
                (byte) 0xf6,
                0x13,
                (byte) 0xf3, // TS_INPUT_CAPABILITYSET::keyboardSubType (not
                // initialized by server)
                (byte) 0x93,
                0x5a,
                0x37,
                (byte) 0xf3, // TS_INPUT_CAPABILITYSET::keyboardFunctionKey (not
                // initialized by server)

                // TS_INPUT_CAPABILITYSET::imeFileName (not initialized by
                // server)
                0x00, (byte) 0x90, 0x30, (byte) 0xe1, 0x34, 0x1c, 0x38,
                (byte) 0xf3, 0x40, (byte) 0xf6, 0x13, (byte) 0xf3, 0x04, 0x00,
                0x00, 0x00, 0x4c, 0x54, (byte) 0xdc, (byte) 0xe2, 0x08, 0x50,
                (byte) 0xdc, (byte) 0xe2, 0x01, 0x00, 0x00, 0x00, 0x08, 0x50,
                (byte) 0xdc, (byte) 0xe2, 0x00, 0x00, 0x00, 0x00, 0x38,
                (byte) 0xf6, 0x13, (byte) 0xf3, 0x2e, 0x05, 0x38, (byte) 0xf3,
                0x08, 0x50, (byte) 0xdc, (byte) 0xe2, 0x2c, (byte) 0xf6, 0x13,
                (byte) 0xf3, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x0a, 0x00,
                0x01, 0x00, 0x19, 0x00,

                // RAIL Capability Set (8 bytes)
                // 0x17, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00,
                //
                0x17, 0x00, // TS_RAIL_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_RAIL (23)
                0x08, 0x00, // TS_RAIL_CAPABILITYSET::lengthCapability = 8 bytes

                0x00, 0x00, 0x00, 0x00, // TS_RAIL_CAPABILITYSET::railSupportLevel
                ...
                // 0x00,
                //
                0x18, 0x00, // TS_WINDOW_CAPABILITYSET::capabilitySetType =
                // CAPSTYPE_WINDOW (24)
                0x0b, 0x00, // TS_WINDOW_CAPABILITYSET::lengthCapability = 11
                // bytes

                0x00, 0x00, 0x00, 0x00, // TS_WINDOW_CAPABILITYSET::wndSupportLevel

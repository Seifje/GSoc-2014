...
public class ServerLicenseErrorPDUValidClient extends OneTimeSwitch {
    ...
    // * Server Error alert
    //
    // 03 00 00 22 02 F0 80 68 00 01 03 EB 70 14 80 00 F1 BC FF 03 10 00 07 00
    // 00 00 02 00 00 00 04 00 00 00
    //
    //
    // Frame: Number = 30, Captured Frame Length = 91, MediaType =
    ...
    // ServerRedirectionPacket: (.....0..........) Not Standard Security Server
    // Redirection PDU
    // ImprovedChecksumForMACG: (....0...........) Not Improved Checksum for MAC
    // Generation
    ...
    // - Flags: 3 (0x3)
    // LicenseProtocolVersionMask: (....0011) RDP 5.0, 5.1, 5.2, 6.0, 6.1, and
    // 7.0
    // Unused: (.000....)
    // ExtendedErrorMSGsupported: (0.......) that extended error information
    // using the License Error Message is NOT supported.
    // MsgSize: 16 (0x10)

...
public class ClientPacketSniffer extends PacketSniffer {
    ...
    private static final Pair[] clientRegexps = new Pair[] {
        ...
        new Pair("Client Info",
                "03 00 XX XX 02 F0 80 64 00 03 03 EB 70 XX XX XX XX 00 00"),
                new Pair("Client ConfirmActivePDU",
                        "03 00 XX XX 02 F0 80 64 00 03 03 EB 70 XX XX XX XX 13 00"),
                        new Pair(
                                "Client SynchronizePDU",
                                "03 00 XX XX 02 F0 80 64 00 03 03 EB 70 XX XX XX XX 17 00 EC 03 EA 03 XX 00 XX XX XX XX 1F"),
                                new Pair(
                                        "Client ControlPDU",
                                        "03 00 XX XX 02 F0 80 64 00 03 03 EB 70 XX XX XX XX 17 00 EC 03 EA 03 XX 00 XX XX XX XX 14"),
                                        new Pair(
                                                "Client FontListPDU",
                                                "03 00 XX XX 02 F0 80 64 00 03 03 EB 70 XX XX XX XX 17 00 EC 03 EA 03 XX 00 XX XX XX XX 27"),
                                                new Pair(
                                                        "Client BitmapCachePersistentList",
                                                        "03 00 XX XX 02 F0 80 64 00 03 03 EB 70 XX XX XX XX 17 00 EC 03 EA 03 XX XX XX XX XX XX 2b"),

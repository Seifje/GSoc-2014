...
/**
 * DeleteBucket bean class
 */

public class DeleteBucket implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DeleteBucket".equals(type)) {
                            ...
                            return (DeleteBucket)com.amazon.s3.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }

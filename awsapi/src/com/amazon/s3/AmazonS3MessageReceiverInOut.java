        ...
        try {
            ...
            if ((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)) {
                ...
                if ("getBucketAccessControlPolicy".equals(methodName)) {
                    ...
                    com.amazon.s3.GetBucketAccessControlPolicy wrappedParam = (com.amazon.s3.GetBucketAccessControlPolicy)fromOM(msgContext.getEnvelope().getBody()
                ...
                if ("getObjectAccessControlPolicy".equals(methodName)) {
                    ...
                    com.amazon.s3.GetObjectAccessControlPolicy wrappedParam = (com.amazon.s3.GetObjectAccessControlPolicy)fromOM(msgContext.getEnvelope().getBody()
                ...
                if ("setBucketAccessControlPolicy".equals(methodName)) {
                    ...
                    com.amazon.s3.SetBucketAccessControlPolicy wrappedParam = (com.amazon.s3.SetBucketAccessControlPolicy)fromOM(msgContext.getEnvelope().getBody()
                ...
                if ("setObjectAccessControlPolicy".equals(methodName)) {
                    ...
                    com.amazon.s3.SetObjectAccessControlPolicy wrappedParam = (com.amazon.s3.SetObjectAccessControlPolicy)fromOM(msgContext.getEnvelope().getBody()

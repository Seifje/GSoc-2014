...
/**
 * GetBucketAccessControlPolicy.java
 *
...
/**
 * GetBucketAccessControlPolicy bean class
 */
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetBucketAccessControlPolicy".equals(type)) {
                            ...
                            return (GetBucketAccessControlPolicy)com.amazon.s3.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }

...
public class DisassociateAddressType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * DisassociateAddressType Namespace URI =
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DisassociateAddressType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DisassociateAddressType", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static DisassociateAddressType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DisassociateAddressType object = new DisassociateAddressType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DisassociateAddressType".equals(type)) {
                            ...
                            return (DisassociateAddressType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }

...
/**
 * RevokeSecurityGroupEgressType bean class
 */

public class RevokeSecurityGroupEgressType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * RevokeSecurityGroupEgressType Namespace URI =
    ...
    public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
            ...
            public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                RevokeSecurityGroupEgressType.this.serialize(parentQName, factory, xmlWriter);
            }
        };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":RevokeSecurityGroupEgressType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "RevokeSecurityGroupEgressType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static RevokeSecurityGroupEgressType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RevokeSecurityGroupEgressType object = new RevokeSecurityGroupEgressType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RevokeSecurityGroupEgressType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RevokeSecurityGroupEgressType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }

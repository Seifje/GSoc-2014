...
/**
 * DescribeNetworkInterfacesResponseType bean class
 */

public class DescribeNetworkInterfacesResponseType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * DescribeNetworkInterfacesResponseType Namespace URI =
    ...
    protected com.amazon.ec2.NetworkInterfaceSetType localNetworkInterfaceSet;

    /**
     * Auto generated getter method
     * 
     * @return com.amazon.ec2.NetworkInterfaceSetType
     */
    public com.amazon.ec2.NetworkInterfaceSetType getNetworkInterfaceSet() {
     ...
     *            NetworkInterfaceSet
     */
    public void setNetworkInterfaceSet(com.amazon.ec2.NetworkInterfaceSetType param) {
    ...
    public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
            ...
            public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                DescribeNetworkInterfacesResponseType.this.serialize(parentQName, factory, xmlWriter);
            }
        };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DescribeNetworkInterfacesResponseType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeNetworkInterfacesResponseType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static DescribeNetworkInterfacesResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeNetworkInterfacesResponseType object = new DescribeNetworkInterfacesResponseType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeNetworkInterfacesResponseType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeNetworkInterfacesResponseType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "networkInterfaceSet").equals(reader.getName())) {
                    ...
                    object.setNetworkInterfaceSet(com.amazon.ec2.NetworkInterfaceSetType.Factory.parse(reader));

...
public class DetachVolumeResponseType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * DetachVolumeResponseType Namespace URI =
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DetachVolumeResponseType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DetachVolumeResponseType", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static DetachVolumeResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DetachVolumeResponseType object = new DetachVolumeResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DetachVolumeResponseType".equals(type)) {
                            ...
                            return (DetachVolumeResponseType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }

...
public class FilterSetType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * FilterSetType Namespace URI = http://ec2.amazonaws.com/doc/2012-08-15/
    ...
    public void addItem(com.amazon.ec2.FilterType param) {
        ...
        list.add(param);
        this.localItem = (com.amazon.ec2.FilterType[])list.toArray(new com.amazon.ec2.FilterType[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":FilterSetType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "FilterSetType", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static FilterSetType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            FilterSetType object = new FilterSetType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"FilterSetType".equals(type)) {
                            ...
                            return (FilterSetType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "item").equals(reader.getName())) {
                    ...
                    object.setItem((com.amazon.ec2.FilterType[])org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(com.amazon.ec2.FilterType.class, list1));

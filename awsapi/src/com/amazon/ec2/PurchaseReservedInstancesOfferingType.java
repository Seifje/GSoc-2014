...
/**
 * PurchaseReservedInstancesOfferingType bean class
 */

public class PurchaseReservedInstancesOfferingType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * PurchaseReservedInstancesOfferingType Namespace URI =
    ...
    /**
     * field for LimitPrice
     */

    protected com.amazon.ec2.ReservedInstanceLimitPriceType localLimitPrice;
     ...
     */
    protected boolean localLimitPriceTracker = false;

    /**
     * Auto generated getter method
     * 
     * @return com.amazon.ec2.ReservedInstanceLimitPriceType
     */
    public com.amazon.ec2.ReservedInstanceLimitPriceType getLimitPrice() {
        return localLimitPrice;
    }
     ...
     *            LimitPrice
     */
    public void setLimitPrice(com.amazon.ec2.ReservedInstanceLimitPriceType param) {

        if (param != null) {
            // update the setting tracker
            localLimitPriceTracker = true;
        } else {
            localLimitPriceTracker = false;

        }

        this.localLimitPrice = param;
    ...
    public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
            ...
            public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                PurchaseReservedInstancesOfferingType.this.serialize(parentQName, factory, xmlWriter);
            }
        };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        xmlWriter.writeEndElement();
        if (localLimitPriceTracker) {
            if (localLimitPrice == null) {
                throw new org.apache.axis2.databinding.ADBException("limitPrice cannot be null!!");
            }
            localLimitPrice.serialize(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "limitPrice"), factory, xmlWriter);
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localLimitPriceTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "limitPrice"));

            if (localLimitPrice == null) {
                throw new org.apache.axis2.databinding.ADBException("limitPrice cannot be null!!");
            }
            elementList.add(localLimitPrice);
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static PurchaseReservedInstancesOfferingType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PurchaseReservedInstancesOfferingType object = new PurchaseReservedInstancesOfferingType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PurchaseReservedInstancesOfferingType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (PurchaseReservedInstancesOfferingType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "limitPrice").equals(reader.getName())) {

                    object.setLimitPrice(com.amazon.ec2.ReservedInstanceLimitPriceType.Factory.parse(reader));

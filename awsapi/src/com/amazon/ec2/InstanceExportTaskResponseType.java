...
/**
 * InstanceExportTaskResponseType bean class
 */

public class InstanceExportTaskResponseType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * InstanceExportTaskResponseType Namespace URI =
     ...
     */
    protected boolean localTargetEnvironmentTracker = false;
    ...
    public void setTargetEnvironment(java.lang.String param) {
        ...
        if (param != null) {
            ...
            localTargetEnvironmentTracker = true;
        } else {
            localTargetEnvironmentTracker = false;
    ...
    public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
            ...
            public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                InstanceExportTaskResponseType.this.serialize(parentQName, factory, xmlWriter);
            }
        };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":InstanceExportTaskResponseType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "InstanceExportTaskResponseType", xmlWriter);
            }
        ...
        if (localTargetEnvironmentTracker) {
            namespace = "http://ec2.amazonaws.com/doc/2012-08-15/";
            if (!namespace.equals("")) {
                prefix = xmlWriter.getPrefix(namespace);
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static InstanceExportTaskResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            InstanceExportTaskResponseType object = new InstanceExportTaskResponseType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"InstanceExportTaskResponseType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (InstanceExportTaskResponseType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }

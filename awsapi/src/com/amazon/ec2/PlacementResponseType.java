...
/**
 * PlacementResponseType bean class
 */

public class PlacementResponseType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * PlacementResponseType Namespace URI =
    ...
    protected java.lang.String localTenancy;
     ...
     * include this field in the serialized XML
     */
    protected boolean localTenancyTracker = false;
     ...
     *            Tenancy
     */
    public void setTenancy(java.lang.String param) {

        if (param != null) {
            // update the setting tracker
            localTenancyTracker = true;
        } else {
            localTenancyTracker = false;

        }

        this.localTenancy = param;
    ...
    public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
            ...
            public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                PlacementResponseType.this.serialize(parentQName, factory, xmlWriter);
            }
        };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":PlacementResponseType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "PlacementResponseType", xmlWriter);
            }
        ...
        if (localTenancyTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "tenancy", namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);

                } else {
                    xmlWriter.writeStartElement(namespace, "tenancy");
                }

            } else {
                xmlWriter.writeStartElement("tenancy");
            }

            if (localTenancy == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("tenancy cannot be null!!");

            } else {

                xmlWriter.writeCharacters(localTenancy);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localTenancyTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "tenancy"));

            if (localTenancy != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTenancy));
            } else {
                throw new org.apache.axis2.databinding.ADBException("tenancy cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static PlacementResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PlacementResponseType object = new PlacementResponseType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PlacementResponseType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (PlacementResponseType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "tenancy").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setTenancy(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));

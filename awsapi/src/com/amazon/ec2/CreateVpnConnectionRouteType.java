...
public class CreateVpnConnectionRouteType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * CreateVpnConnectionRouteType Namespace URI =
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":CreateVpnConnectionRouteType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "CreateVpnConnectionRouteType", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static CreateVpnConnectionRouteType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CreateVpnConnectionRouteType object = new CreateVpnConnectionRouteType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CreateVpnConnectionRouteType".equals(type)) {
                            ...
                            return (CreateVpnConnectionRouteType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }

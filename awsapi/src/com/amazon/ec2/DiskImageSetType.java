...
public class DiskImageSetType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * DiskImageSetType Namespace URI = http://ec2.amazonaws.com/doc/2012-08-15/
    ...
    public void addItem(com.amazon.ec2.DiskImageType param) {
        ...
        list.add(param);
        this.localItem = (com.amazon.ec2.DiskImageType[])list.toArray(new com.amazon.ec2.DiskImageType[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DiskImageSetType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DiskImageSetType", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static DiskImageSetType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DiskImageSetType object = new DiskImageSetType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DiskImageSetType".equals(type)) {
                            ...
                            return (DiskImageSetType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "item").equals(reader.getName())) {
                    ...
                    object.setItem((com.amazon.ec2.DiskImageType[])org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(com.amazon.ec2.DiskImageType.class, list1));

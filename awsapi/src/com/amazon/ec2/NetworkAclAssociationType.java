...
/**
 * NetworkAclAssociationType bean class
 */

public class NetworkAclAssociationType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * NetworkAclAssociationType Namespace URI =
    ...
    /**
     * field for NetworkAclAssociationId
     */

    protected java.lang.String localNetworkAclAssociationId;
    ...
    public java.lang.String getNetworkAclAssociationId() {
        return localNetworkAclAssociationId;
    }
     ...
     */
    public void setNetworkAclAssociationId(java.lang.String param) {

        this.localNetworkAclAssociationId = param;
    ...
    public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
            ...
            public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                NetworkAclAssociationType.this.serialize(parentQName, factory, xmlWriter);
            }
        };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":NetworkAclAssociationType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "NetworkAclAssociationType", xmlWriter);
            }
        ...
        if (!namespace.equals("")) {
            ...
            if (prefix == null) {
                ...
                xmlWriter.writeStartElement(prefix, "networkAclAssociationId", namespace);
                xmlWriter.writeNamespace(prefix, namespace);
                xmlWriter.setPrefix(prefix, namespace);

            } else {
                xmlWriter.writeStartElement(namespace, "networkAclAssociationId");
            }

        } else {
            xmlWriter.writeStartElement("networkAclAssociationId");
        }

        if (localNetworkAclAssociationId == null) {
            // write the nil attribute

            throw new org.apache.axis2.databinding.ADBException("networkAclAssociationId cannot be null!!");

        } else {

            xmlWriter.writeCharacters(localNetworkAclAssociationId);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        elementList.add(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "networkAclAssociationId"));

        if (localNetworkAclAssociationId != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNetworkAclAssociationId));
        } else {
            throw new org.apache.axis2.databinding.ADBException("networkAclAssociationId cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static NetworkAclAssociationType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            NetworkAclAssociationType object = new NetworkAclAssociationType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"NetworkAclAssociationType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (NetworkAclAssociationType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "networkAclAssociationId").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setNetworkAclAssociationId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));

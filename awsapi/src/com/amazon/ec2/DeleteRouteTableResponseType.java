...
public class DeleteRouteTableResponseType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * DeleteRouteTableResponseType Namespace URI =
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DeleteRouteTableResponseType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DeleteRouteTableResponseType", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static DeleteRouteTableResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DeleteRouteTableResponseType object = new DeleteRouteTableResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DeleteRouteTableResponseType".equals(type)) {
                            ...
                            return (DeleteRouteTableResponseType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }

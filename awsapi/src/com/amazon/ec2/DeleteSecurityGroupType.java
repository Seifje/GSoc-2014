...
public class DeleteSecurityGroupType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * DeleteSecurityGroupType Namespace URI =
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DeleteSecurityGroupType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DeleteSecurityGroupType", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static DeleteSecurityGroupType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DeleteSecurityGroupType object = new DeleteSecurityGroupType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DeleteSecurityGroupType".equals(type)) {
                            ...
                            return (DeleteSecurityGroupType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }

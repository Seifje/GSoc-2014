...
/**
 * ImportVolumeTaskDetailsType bean class
 */

public class ImportVolumeTaskDetailsType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * ImportVolumeTaskDetailsType Namespace URI =
    ...
    public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
            ...
            public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                ImportVolumeTaskDetailsType.this.serialize(parentQName, factory, xmlWriter);
            }
        };
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static ImportVolumeTaskDetailsType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ImportVolumeTaskDetailsType object = new ImportVolumeTaskDetailsType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ImportVolumeTaskDetailsType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ImportVolumeTaskDetailsType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }

...
public interface SBucket {
     ...
     * private Long id;
     * 
     * private String name; private String ownerCanonicalId;
     * 
     * private SHost shost; private Date createTime;
     * 
     * private int versioningStatus;
     * 
     * private Set<SObject> objectsInBucket = new HashSet<SObject>();
     * 
     * public SBucket() { versioningStatus = VERSIONING_NULL; }
     * 
     ...
     * 
     * public String getOwnerCanonicalId() { return ownerCanonicalId; }
     * 
     * public void setOwnerCanonicalId(String ownerCanonicalId) {
     * this.ownerCanonicalId = ownerCanonicalId; }
     * 
     * public SHost getShost() { return shost; }
     * 
     * public void setShost(SHost shost) { this.shost = shost; }
     * 
     ...
     * createTime; }
     * 
     * public int getVersioningStatus() { return versioningStatus; }
     * 
     * public void setVersioningStatus( int versioningStatus ) {
     * this.versioningStatus = versioningStatus; }
     * 
     * public Set<SObject> getObjectsInBucket() { return objectsInBucket; }
     * 
     ...
     * true;
     * 
     * if(!(other instanceof SBucket)) return false;
     * 

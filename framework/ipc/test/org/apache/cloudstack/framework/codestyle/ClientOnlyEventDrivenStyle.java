...
public class ClientOnlyEventDrivenStyle {
    ...
    public void AsyncCallRpcService() {
        ...
        _rpcProvider.newCall("host-2").setCommand("TestCommand").setCommandArg(cmd).setTimeout(10000).setCallbackDispatcher(callbackDispatcher).setContext("Context Object")

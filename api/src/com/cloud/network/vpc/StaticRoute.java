...
public interface StaticRoute extends ControlledEntity, Identity, InternalIdentity {
    enum State {
        ...
        // conflict detection. Routes in this state can not be sent to
        // VPC virtual router.
        ...
        // active.
        Revoke, // Revoke means this route has been revoked. If this route has
        // been sent to the VPC router, the route will be deleted from
        // database.

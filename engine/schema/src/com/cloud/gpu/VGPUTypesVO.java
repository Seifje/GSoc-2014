...
public class VGPUTypesVO implements InternalIdentity {
    ...
    public VGPUTypesVO(long gpuGroupId, String vgpuType, long videoRam, long maxHeads, long maxResolutionX, long maxResolutionY, long maxVgpuPerPgpu, long remainingCapacity,
            long maxCapacity) {

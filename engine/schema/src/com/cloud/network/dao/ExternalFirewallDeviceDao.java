...
public interface ExternalFirewallDeviceDao extends GenericDao<ExternalFirewallDeviceVO, Long> {
     ...
     *            physical Network Id
     * @return list of ExternalFirewallDeviceVO for the devices added in to this
     *         physical network.
     */

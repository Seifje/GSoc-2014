    ...
    public boolean updateState(State currentState, Event event, State nextState, DataObjectInStore vo, Object data) {
        ...
        if (rows == 0 && s_logger.isDebugEnabled()) {
            ...
            if (dbVol != null) {
                ...
                str.append(": New Data={id=").append(volHost.getId()).append("; state=").append(nextState).append("; event=").append(event).append("; updatecount=")
                .append(volHost.getUpdatedCount()).append("; updatedTime=").append(volHost.getUpdated());
                str.append(": stale Data={id=").append(volHost.getId()).append("; state=").append(currentState).append("; event=").append(event).append("; updatecount=")

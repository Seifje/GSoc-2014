...
public class ClusterBasedAgentLoadBalancerPlanner extends AdapterBase implements AgentLoadBalancerPlanner {
    ...
    public List<HostVO> getHostsToRebalance(long msId, int avLoad) {
        ...
        s_logger.debug("Management server " + msId + " can give away " + hostsToGive + " as it currently owns " + allHosts.size() + " and the average agent load in the system is "
                + avLoad + "; finalyzing list of hosts to give away...");

...
/**
 * ConfigurationManager handles adding pods/zones, changing IP ranges, enabling
 * external firewalls, and editing configuration values
 *
 */
public interface ConfigurationManager {
    ...
    // VirtualMachine.Type vm_typeType, String name, int cpu, int ramSize, int
    // speed, String displayText, boolean localStorageRequired,
    // boolean offerHA, boolean limitResourceUse, boolean volatileVm, String
    // tags, Long domainId, String hostTag, Integer networkRate, String
    // deploymentPlanner, Map<String, String> details,
    // Long bytesReadRate, Long bytesWriteRate, Long iopsReadRate, Long
    // iopsWriteRate);
    ...
    // */
    // DiskOfferingVO createDiskOffering(Long domainId, String name, String
    // description, Long numGibibytes, String tags, boolean isCustomized,
    // boolean localStorageRequired, boolean isDisplayOfferingEnabled, Boolean
     ...
     *            (true if it is ok to not validate that gateway IP address
     *            overlap with Start/End IP of the POD)
     * @return Pod
     */
    ...
    /**
     * Deletes a VLAN from the database, along with all of its IP addresses.
     * Will not delete VLANs that have allocated IP addresses.
     *
     * @param userId
     * @param vlanDbId
     * @param caller
    ...
    Vlan createVlanAndPublicIpRange(long zoneId, long networkId, long physicalNetworkId, boolean forVirtualNetwork, Long podId, String startIP, String endIP, String vlanGateway,
            String vlanNetmask, String vlanId, Account vlanOwner, String startIPv6, String endIPv6, String vlanIp6Gateway, String vlanIp6Cidr)

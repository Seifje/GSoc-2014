...
/**
 * Capacity Manager manages the different capacities available within the Cloud
 * Stack.
 *
 */
public interface CapacityManager {
    ...
    /**
     * @param hostId
     *            Id of the host to check capacity
     * @param cpu
     *            required CPU
     * @param ram
     *            required RAM
     * @param cpuOverprovisioningFactor
     *            factor to apply to the actual host cpu
     */
     ...
     * @param pool
     *            storage pool
     * @param templateForVmCreation
     *            template that will be used for vm creation
    ...
    /**
     * Check if specified host has capability to support cpu cores and speed
     * freq
     *
     * @param hostId
     *            the host to be checked
